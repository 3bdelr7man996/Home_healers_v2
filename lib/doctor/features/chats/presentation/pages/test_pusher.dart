...
class TestMyPusher extends StatefulWidget {
  const TestMyPusher({Key? key}) : super(key: key);

  @override
  State<TestMyPusher> createState() => _TestMyPusherState();
}

class _TestMyPusherState extends State<TestMyPusher> {
  ...
  void log(String text) {
    ...
    setState(() {
      _log += text + "\n";
      // Timer(
      //     const Duration(milliseconds: 100) as Scheduler,
      //     () => _listViewController
  ...
  Future<void> initPlatformState() async {
    ...
    // SharedPreferences prefs = await SharedPreferences.getInstance();
    setState(() {
      _apiKey.text = AppStrings.PUSHER_APP_KEY;
      _cluster.text = AppStrings.PUSHER_APP_CLUSTER;
      _channelName.text = "chat.265";
      _eventName.text = 'chat';
      _data.text = "msg msg 333";
    });
  }
