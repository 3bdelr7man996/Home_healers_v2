...
class SignInScreenForPatient extends StatefulWidget {
  SignInScreenForPatient({super.key});

  @override
  State<SignInScreenForPatient> createState() => _SignInScreenForPatient();
}

class _SignInScreenForPatient extends State<SignInScreenForPatient> {
  @override
